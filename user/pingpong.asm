...
int main() {
  ...
  10:	36e080e7          	jalr	878(ra) # 37a <pipe>
    if(fork() == 0) {
  14:	00000097          	auipc	ra,0x0
  18:	34e080e7          	jalr	846(ra) # 362 <fork>
  1c:	e535                	bnez	a0,88 <main+0x88>
        //子进程
        char buf[100];
        read(p[0], buf, sizeof(buf));
  1e:	06400613          	li	a2,100
  22:	f8040593          	addi	a1,s0,-128
  26:	fe842503          	lw	a0,-24(s0)
  2a:	00000097          	auipc	ra,0x0
  2e:	358080e7          	jalr	856(ra) # 382 <read>
        int cur_pid = getpid();
  32:	00000097          	auipc	ra,0x0
  36:	3b8080e7          	jalr	952(ra) # 3ea <getpid>
  3a:	85aa                	mv	a1,a0
        printf("%d: received %s\n", cur_pid, buf);
  3c:	f8040613          	addi	a2,s0,-128
  40:	00001517          	auipc	a0,0x1
  44:	84850513          	addi	a0,a0,-1976 # 888 <malloc+0xe8>
  48:	00000097          	auipc	ra,0x0
  4c:	69a080e7          	jalr	1690(ra) # 6e2 <printf>
        close(p[0]);
  50:	fe842503          	lw	a0,-24(s0)
  54:	00000097          	auipc	ra,0x0
  58:	33e080e7          	jalr	830(ra) # 392 <close>
        write(p[1], "pong",4);
  5c:	4611                	li	a2,4
  5e:	00001597          	auipc	a1,0x1
  62:	84258593          	addi	a1,a1,-1982 # 8a0 <malloc+0x100>
  66:	fec42503          	lw	a0,-20(s0)
  6a:	00000097          	auipc	ra,0x0
  6e:	320080e7          	jalr	800(ra) # 38a <write>
        close(p[1]);
  72:	fec42503          	lw	a0,-20(s0)
  76:	00000097          	auipc	ra,0x0
  7a:	31c080e7          	jalr	796(ra) # 392 <close>
        read(p[0], buf, sizeof(buf));
        int cur_pid = getpid();
        printf("%d: received %s\n",cur_pid, buf);
        close(p[0]);
  ...
  84:	2ea080e7          	jalr	746(ra) # 36a <exit>
        write(p[1], "ping", 4);
  88:	4611                	li	a2,4
  8a:	00001597          	auipc	a1,0x1
  8e:	81e58593          	addi	a1,a1,-2018 # 8a8 <malloc+0x108>
  92:	fec42503          	lw	a0,-20(s0)
  96:	00000097          	auipc	ra,0x0
  9a:	2f4080e7          	jalr	756(ra) # 38a <write>
        close(p[1]);
  9e:	fec42503          	lw	a0,-20(s0)
  a2:	00000097          	auipc	ra,0x0
  a6:	2f0080e7          	jalr	752(ra) # 392 <close>
        wait(0);
  aa:	4501                	li	a0,0
  ac:	00000097          	auipc	ra,0x0
  b0:	2c6080e7          	jalr	710(ra) # 372 <wait>
        read(p[0], buf, sizeof(buf));
  b4:	06400613          	li	a2,100
  b8:	f8040593          	addi	a1,s0,-128
  bc:	fe842503          	lw	a0,-24(s0)
  c0:	00000097          	auipc	ra,0x0
  c4:	2c2080e7          	jalr	706(ra) # 382 <read>
        int cur_pid = getpid();
  c8:	00000097          	auipc	ra,0x0
  cc:	322080e7          	jalr	802(ra) # 3ea <getpid>
  d0:	85aa                	mv	a1,a0
        printf("%d: received %s\n",cur_pid, buf);
  d2:	f8040613          	addi	a2,s0,-128
  d6:	00000517          	auipc	a0,0x0
  da:	7b250513          	addi	a0,a0,1970 # 888 <malloc+0xe8>
  de:	00000097          	auipc	ra,0x0
  e2:	604080e7          	jalr	1540(ra) # 6e2 <printf>
        close(p[0]);
  e6:	fe842503          	lw	a0,-24(s0)
  ea:	00000097          	auipc	ra,0x0
  ee:	2a8080e7          	jalr	680(ra) # 392 <close>
  f2:	b771                	j	7e <main+0x7e>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 452:	46a50513          	addi	a0,a0,1130 # 8b8 <digits>
 456:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 51e:	39eb8b93          	addi	s7,s7,926 # 8b8 <digits>
 ...
 65e:	25690913          	addi	s2,s2,598 # 8b0 <malloc+0x110>
        while(*s != 0){
...
free(void *ap)
{
 ...
 726:	1ae7b783          	ld	a5,430(a5) # 8d0 <freep>
 ...
 754:	00e6ea63          	bltu	a3,a4,768 <free+0x50>
{
 ...
 796:	12f73f23          	sd	a5,318(a4) # 8d0 <freep>
}
 79a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7c8:	10c53503          	ld	a0,268(a0) # 8d0 <freep>
 ...
 7f0:	0e490913          	addi	s2,s2,228 # 8d0 <freep>
  if(p == (char*)-1)
 7f4:	5afd                	li	s5,-1
 7f6:	a88d                	j	868 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7f8:	00000797          	auipc	a5,0x0
 7fc:	0e078793          	addi	a5,a5,224 # 8d8 <base>
 800:	00000717          	auipc	a4,0x0
 804:	0cf73823          	sd	a5,208(a4) # 8d0 <freep>
 808:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 82a:	0aa73523          	sd	a0,170(a4) # 8d0 <freep>
      return (void*)(p + 1);
